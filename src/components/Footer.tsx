...
const Footer = () => {
  ...
  return (
    <footer className="w-full py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none bg-black/20 md:bg-transparent"></div>
        ...
        <div className="glass rounded-2xl p-8 border border-white/20 shadow-lg relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
            <div className="space-y-4">
              ...
              <div className="flex space-x-3 text-accent md:text-white/70">
                <motion.a 
                ...
                <motion.a 
                  ...
                  className="w-9 h-9 rounded-full glass flex items-center justify-center group"
                >
                  <svg viewBox="0 0 256 256" className="w-5 h-5 group-hover:text-accent transition-colors" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g>
